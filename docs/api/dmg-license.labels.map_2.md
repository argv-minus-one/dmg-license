...
[Home](./index.md) &gt; [dmg-license](./dmg-license.md) &gt; [Labels](./dmg-license.labels.md) &gt; [map](./dmg-license.labels.map_2.md)
...
|  options | <code>MapOptions&lt;T, U&gt; &amp; {</code><br/><code>        onNoLanguageName(): U;</code><br/><code>    }</code> |  |
