...
[Home](./index.md) &gt; [dmg-license](./dmg-license.md) &gt; [Labels](./dmg-license.labels.md) &gt; [mapAsync](./dmg-license.labels.mapasync_1.md)
...
|  options | <code>MapOptions&lt;T, Promise&lt;U&gt;&gt; &amp; {</code><br/><code>        onNoLanguageName?: never;</code><br/><code>    }</code> |  |
